...
export default function SettingsPage(){
 ...
 <div className={styles.shell}><aside className={styles.settingsNav}><p>SETTINGS</p><h1>프로필 설정</h1><nav><a href="#profile" className={styles.active}><UserRound/> 프로필</a><a href="#security"><ShieldCheck/> 계정 및 보안</a></nav></aside>
